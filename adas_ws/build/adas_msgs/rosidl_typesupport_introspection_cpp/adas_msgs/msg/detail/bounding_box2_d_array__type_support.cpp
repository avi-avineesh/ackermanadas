...
{
  new (message_memory) adas_msgs::msg::BoundingBox2DArray(_init);
}

void BoundingBox2DArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<adas_msgs::msg::BoundingBox2DArray *>(message_memory);
  typed_message->~BoundingBox2DArray();
}

size_t size_function__BoundingBox2DArray__boxes(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<adas_msgs::msg::BoundingBox2D> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<adas_msgs::msg::BoundingBox2D> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<adas_msgs::msg::BoundingBox2D> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const adas_msgs::msg::BoundingBox2D *>(
    get_const_function__BoundingBox2DArray__boxes(untyped_member, index));
  auto & value = *reinterpret_cast<adas_msgs::msg::BoundingBox2D *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<adas_msgs::msg::BoundingBox2D *>(
    get_function__BoundingBox2DArray__boxes(untyped_member, index));
  const auto & value = *reinterpret_cast<const adas_msgs::msg::BoundingBox2D *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox2DArray_message_member_array[2] = {
  {
    ...
    offsetof(adas_msgs::msg::BoundingBox2DArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<adas_msgs::msg::BoundingBox2D>(),  // members of sub message
    false,  // is key
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(adas_msgs::msg::BoundingBox2DArray, boxes),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBox2DArray_message_members = {
  ...
  2,  // number of fields
  sizeof(adas_msgs::msg::BoundingBox2DArray),
...
get_message_type_support_handle<adas_msgs::msg::BoundingBox2DArray>()
{
  return &::adas_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox2DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, adas_msgs, msg, BoundingBox2DArray)() {
  return &::adas_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox2DArray_message_type_support_handle;
}
