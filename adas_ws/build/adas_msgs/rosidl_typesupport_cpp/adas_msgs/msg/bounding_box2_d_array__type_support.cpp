...
static const _BoundingBox2DArray_type_support_symbol_names_t _BoundingBox2DArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, adas_msgs, msg, BoundingBox2DArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, adas_msgs, msg, BoundingBox2DArray)),
  }
};
...
{
  return &::adas_msgs::msg::rosidl_typesupport_cpp::BoundingBox2DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, adas_msgs, msg, BoundingBox2DArray)() {
  return get_message_type_support_handle<adas_msgs::msg::BoundingBox2DArray>();
}
